...
<head>
    ...
    <meta name="author" content="{{ config('log-viewer.footer.author', 'Mradul Sharma') }}">
    <title>LogViewer - Created by {{ config('log-viewer.footer.author', 'Mradul Sharma') }}</title>
    {{-- Styles --}}
    ...
    <footer class="main-footer">
        <div class="container-fluid">
            ...
            <p class="text-muted pull-right">
                Created with <i class="fa fa-heart"></i> by {{ config('log-viewer.footer.author', 'Mradul Sharma') }} <sup>&copy;</sup>
            </p>
            @endif
        </div>
    </footer>
